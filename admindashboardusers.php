                    ...
                    <table class="w-full">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4  py-3">gendre</th>
                                ...
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="confirmpassword" id="confirmpassword"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="client confirmpassword" required="">
                                    </div>
                
                                    <div>
                                        <label for="agence"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">agence</label>
                                            <select name="" id=""   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                 ...
                                 <option value=""></option>
                                    ...
                                    <div>
                                        <label for="codepostal"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">codepostal</label>
                                        <input type="text" name="codepostal" id="codepostal"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="client codepostal" required="">
                                    </div>
                                    <div>
                                        <label for="email"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="quartier" id="quartier"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="client quartier" required="">
                                    </div>
                                    <div>
                                        <label for="rue"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">rue</label>
                                        <input type="text" name="rue" id="rue"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="client rue" required="">
                                    </div>
                                    <div>
                                        <label for="ville"
