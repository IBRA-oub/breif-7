                        ...
                        <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex justify-center items-center">
                                        ...
                                        <form method="post">
                                            <input type="hidden" name="delete_compte_id" value="">
                                            <button type="submit"
                                        ...
                                        <form method="post">
                                            <input type="hidden" name="update_compte_id" value="">
                ...
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <div
                            ...
                            <button type="button" id="creataccount" onclick="hideCreateClientModal()"
                            ...
                            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                ...
                                <div class="flex justify-center items-center space-x-4">
                                    <button data-modal-toggle="deleteModal" type="button"
                                        ...
                                        cancel</button>
                                    <button type="submit" name="delete_compte_id"
